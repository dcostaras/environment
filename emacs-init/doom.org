...
* config
#+BEGIN_SRC emacs-lisp :tangle ~/.config/doom-emacs/config.el
...
(setq ;; Line numbers are pretty slow all around. The performance boost of
...
(after! (:and clojure-mode cider)
  ...
  (setq cider-clojure-cli-global-options "-A:hashp")
...
;; TODO create command to set repl buffer point to end of buffer
#+END_SRC

* init
#+BEGIN_SRC emacs-lisp :tangle ~/.config/doom-emacs/init.el
...
* packages
#+BEGIN_SRC emacs-lisp :tangle ~/.config/doom-emacs/packages.el
;; -*- no-byte-compile: t; -*-
;;; $DOOMDIR/packages.el
...
* custom
#+BEGIN_SRC emacs-lisp :tangle ~/.config/doom-emacs/custom.el
(custom-set-variables
 ;; custom-set-variables was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(package-selected-packages '(evil-lispy))
 '(safe-local-variable-values
   '((eva-user-id . "ab7f0602-ee6b-486a-b0a2-355db5824050")
     (foo-user-id . "5d77ee1d-5c56-419f-bc1c-fbafd277525b")
     (waldo-user-id . "bc448ab9-16d0-41bb-a2b7-a5b97015e9bd")
     (hugh-user-id . "f9820e02-cc8c-4cb7-b8cc-de706253785a")
