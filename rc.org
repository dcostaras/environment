...
#+begin_src emacs-lisp :mkdirp yes :tangle ~/.emacs.d/.local/cache/templates
...
#+begin_src emacs-lisp :tangle ~/.doom.d/config.el
(rx-define my-clojure-defining-forms
...
(defun my-defining-forms-font-lock ()
  ...
  (font-lock-add-keywords
   ...
   `((,(rx "("
           (* (syntax whitespace))
           (group my-clojure-defining-forms)
           (+ (syntax whitespace))
...
(map! (:localleader
      ...
      (:mode cider-mode
             "C-c C-c" #'eval-top-level-form-and-reload-tilley))
#+end_src
