...
;; TODO put back io.github.*
(deps/add-deps '{:deps {realifelearning/bench {:local/root "/Users/donavan/src/bench"}}})

(ns bench.entrypoint
  (:require
   [org.realifelearning.bench.clj-cli :as clj-cli]
   ;; [org.realifelearning.bench.cli :as cli]
   ))
