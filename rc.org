...
takes 0.163 s
#+begin_src clojure :shebang "#!/usr/bin/env bb" :tangle ~/bin/b
...
{:org.realifelearning.bench/tools
 ...
 {org.realifelearning/belt {:local/root "/Users/donavan/src/rl-belt"}
  ...
  #_#_io.github.nivekuil/nexus {:local/root "/Users/donavan/src/nexus"}}}
  #+end_src
...
#+begin_src clojure :tangle ~/src/timesheets/_bench.edn
{:org.realifelearning.bench.tools/cider
 {:nrepl-port 9001}}
#+end_src
...
#+begin_src clojure :tangle ~/src/hai/projects/apps-script/_bench.edn
{:org.realifelearning.bench.tools/cider
 {:nrepl-port 9001}

 :org.realifelearning.bench.deps/default-aliases
 [:clj :developer-tools/firebase :developer-tools/firebase-tests]}
#+end_src

*** hai-ui

#+begin_src clojure :tangle ~/src/hai-ui/_bench.edn
{:org.realifelearning.bench.tools/cider
 {:nrepl-port 9000
  :cljs-nrepl? true}
...
- :: :PROPERTIES:
:ID:       a297c795-a21f-493f-b271-4693040557b3
:END:
...
{:org.realifelearning.bench.tools/cider
 ...
 {:platform #include "projects/platform/_bench.edn"
  :web-extension #include "projects/web-extension/_bench.edn"
  }
 }
#+end_src
...
{:org.realifelearning.bench.monorepo/project-path "projects/web-extension"
...
* Nix
To reenable nix things like karabiner run ~darwin-rebuild switch~
** Shell setup
