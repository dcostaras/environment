...
{:mvn/repos {"sonatype" {:url "https://oss.sonatype.org/content/repositories/snapshots/"}
 ...
 { ;; pull in specific versions of Clojure:
  ...
  :cider-nrepl {:extra-deps {cider/cider-nrepl {:mvn/version "0.25.6"}
                             refactor-nrepl/refactor-nrepl {:mvn/version "2.5.0"}}}

  :local-fulcro {:override-deps {com.fulcrologic/fulcro {:local/root "~/src/fulcro"}}}
  }}
#+END_SRC
...
{:deps-aliases [:debug-tools :cider-nrepl]
...
#+begin_src sh :shebang "#!/bin/bash" :tangle ~/bin/jra-backend
...
cd ~/src/jra && \
    ...
    -A:dev:test:kondo:debug-tools \
    -J-Dtrace -J-Dghostwheel.enabled=true \
    -m nrepl.cmdline\
    --middleware '["com.gfredericks.debug-repl/wrap-debug-repl","refactor-nrepl.middleware/wrap-refactor","cider.nrepl/cider-middleware"]'
#+end_src

#+begin_src sh :shebang "#!/bin/bash" :tangle ~/bin/jra-frontend
cd ~/src/jra && npm run shadow-server
#+end_src
