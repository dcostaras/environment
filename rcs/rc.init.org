...
#+begin_src sh :shebang "#!/bin/bash" :tangle ~/bin/doomacs
  DOOMDIR=~/.config/doom-emacs EMACSDIR=~/.doom-emacs open /Applications/Emacs.app -n --args --with-profile doomacs
#+end_src

#+begin_src sh :shebang "#!/bin/bash" :tangle ~/bin/doomsync
  DOOMDIR=~/.config/doom-emacs EMACSDIR=~/.doom-emacs ./doom sync
#+end_src
